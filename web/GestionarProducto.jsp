   ...
   <head>
    ...
    <body>
	  ...
	  <table>
			<thead>
				<tr>
					<th>Producto</th><th>Size</th><th>Gramos</th><th>Presentacion</th><th>Precio</th><th>CRUD</th>
				</tr>
			</thead>
				<div class="BotonesTabla"><div class="BotonAgregar"><input type="button" value="Agregar Producto"></div></div>
			<tr>
				<td></td><td></td><td></td><td></td><td></td><td><div class="BotonesTabla">
